 ...
 * @author Bruno
 */
public class DelParceiro extends javax.swing.JFrame {
    ...
    private void cbxVendedorAncestorAdded(javax.swing.event.AncestorEvent evt) {//GEN-FIRST:event_cbxVendedorAncestorAdded
        ...
        try {
            for (ParceiroNegocio v : dao.listarParceiros()) {
                cbxVendedor.addItem("Parceiro ID: " + v.getId_pn());
            }
            LogController.createLog("Parceiro deletado", "I");
        } catch (SQLException ex) {
            LogController.createLog("Erro ao deletar Parceiro" + ex.getMessage(), "W");
    ...
    private void btnGerarXMLActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarXMLActionPerformed
        ...
        if (selectedItem != null) {
            ...
            String id_parceiro = arrSplit;
            int parceiro = Integer.valueOf(id_parceiro);


            ParceiroNegocioDTO parceirodto = new ParceiroNegocioDTO();

            parceirodto.setId_pn(parceiro);

            ParceiroNegocioDAO parceirodao = new ParceiroNegocioDAO();

            try {
                parceirodao.deleteParceiro(parceirodto);
                JOptionPane.showMessageDialog(null, "Parceiro deletado com sucesso!");
            } catch (SQLException ex) {
                //Logger.getLogger(InserirVenda.class.getName()).log(Level.SEVERE, null, ex);
            };
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DelParceiro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DelParceiro().setVisible(true);
            }
        });
    }
