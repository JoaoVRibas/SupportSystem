 ...
 * @author Bruno
 */
public class CadParceiro extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastrar Parceiro");
    ...
    private void btnCadClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadClienteActionPerformed
        try {
            ...
            parceiro.setNome_pn(cbxNomeCliente.getText());
            if (rbtnTipoPf.isSelected()) {
                parceiro.setId_tipo_pn(1);
            ...
            LogController.createLog("Erro ao cadastrar Parceiro", "W");
        }
        LogController.createLog("Parceiro cadastrado", "I");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadParceiro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadParceiro().setVisible(true);
            }
        });
    }
